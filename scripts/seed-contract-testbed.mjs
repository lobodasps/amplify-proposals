...
// ─── Schema imports ───────────────────────────────────────────────────────────
import {
  entities, orderTypes, departments, serviceTypes,
...
const s01 = await insertContract({
  ...
  performingCompanyName: "JPCL", performingCompanyId: "fddf0d5c",
...
const s07 = await insertContract({
  ...
  clientName: "NYC DDC", clientOrgId: ORG_DDC,
  ownerName: "NYC DDC", ownerOrgId: ORG_DDC,
  performingCompanyName: "Strans Engineering", performingCompanyId: "e45a26d6",
  status: "active", level: 1,
  value: 0, computedContractValue: 0,
...
const s25_sub = await insertContract({
  ...
  clientName: "JPCL", performingCompanyName: "Strans Engineering", performingCompanyId: "e45a26d6",
  primeOrgId: ORG_PARSONS,
