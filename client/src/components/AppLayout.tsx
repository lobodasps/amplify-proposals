    ...
    items: [
      {
        ...
        href: "/knowledge-hub",
        icon: BookOpen,
        description: "Boilerplate, past proposals & templates",
      },
      {
        label: "Assets (DAM)",
        href: "/assets",
        icon: FolderOpen,
        description: "Images, logos & marketing materials",
      },
      {
        label: "Personnel",
        href: "/personnel",
        icon: Users,
        description: "Staff resumes & qualifications",
      },
      {
        label: "Projects",
        href: "/projects",
        icon: Building2,
        description: "Past project experience database",
      },
      {
        label: "Glossary",
        href: "/glossary",
      ...
      },
      {
        ...
        icon: Library,
        description: "Reference documents & guides",
      },
    ],
  },
  {
